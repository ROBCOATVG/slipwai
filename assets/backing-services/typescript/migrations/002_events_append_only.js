 ...
 *
 * REVOKE is issued as well, so the guarantee still holds once ownership is separated.
 * DROP TABLE is deliberately still permitted — migrations and test teardown need it, and a schema
 * change is a reviewed event, not a silent row rewrite.
 */
export const up = (pgm) => {
  pgm.sql(`
