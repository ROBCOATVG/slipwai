...
# by the credential that creates everything else in this stack. The deploy role owns this account; it owns
# nothing in an Auth0 tenant. So this file is applied with a second credential, a machine-to-machine
