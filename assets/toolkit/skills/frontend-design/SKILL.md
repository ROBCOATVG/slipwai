...
> Vendored verbatim from Anthropic's [`frontend-design` at `41bbe19`](https://github.com/anthropics/skills/tree/41bbe19d1a1a7eaab5e7bb9050a417e5c6cffc8f/skills/frontend-design) (Apache-2.0; the complete notice is in `LICENSE`, the exact provenance in [`references/source-notes.md`](references/source-notes.md)). In this repository the brief has a standing record: `docs/design.md` says what has already been decided about the screens and wins wherever it speaks, the token system this skill asks you to plan is written into the browser app's `tokens.css`, and the reasons go on that page in the same commit as the screen.
