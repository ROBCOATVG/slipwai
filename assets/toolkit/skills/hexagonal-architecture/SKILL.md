...
{{example: hexagonal-architecture/port-interface-definitions}}
...
{{example: hexagonal-architecture/driven-adapter-and-fake-implementation}}
...
{{example: hexagonal-architecture/adapter-error-translation}}
...
{{example: hexagonal-architecture/reads-vs-writes-query-function-example}}
...
{{example: hexagonal-architecture/dependency-injection-order-placement}}
...
{{example: hexagonal-architecture/composition-root-http-entrypoint}}
...
{{example: hexagonal-architecture/composition-root-queue-entrypoint}}
...
{{example: hexagonal-architecture/antipattern-domain-depends-on-infrastructure}}

### Business Logic in Adapters

Route handlers or repositories contain business rules instead of delegating to domain.

{{example: hexagonal-architecture/antipattern-business-logic-in-adapter}}

### Bypass Adapters

Route handler accesses the database directly instead of going through a port.

{{example: hexagonal-architecture/antipattern-bypass-adapter}}
...
{{example: hexagonal-architecture/antipattern-technology-shaped-port}}
...
{{example: hexagonal-architecture/antipattern-pattern-shaped-names}}
