...
{{example: hexagonal-architecture/cross-cutting-auth-driving-adapter}}

{{example: hexagonal-architecture/cross-cutting-use-case-identity}}

**Authorization (business rules about who can do what)** is domain logic:

{{example: hexagonal-architecture/cross-cutting-domain-authorization}}
...
{{example: hexagonal-architecture/cross-cutting-technical-telemetry-adapters}}
...
{{example: hexagonal-architecture/cross-cutting-domain-probe-port}}
...
{{example: hexagonal-architecture/cross-cutting-transactional-persistence-port}}
...
{{example: hexagonal-architecture/cross-cutting-error-formatting-http}}
