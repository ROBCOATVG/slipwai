...
reachability path -- from the project's code index where `AGENTS.md` names one,
since reachability is a call-path question and a text search cannot answer one --
and resolve the behavior authority. Delete it only when the
