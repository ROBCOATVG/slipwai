...
| `make sonar` *(Sonar extension)* | Publishes analysis and any existing coverage reports to SonarQube or SonarCloud | Needs a remote host and token; native lint, typecheck and tests remain the deterministic merge gate |
